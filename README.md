...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libuwebsockets-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libuwebsockets-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libuwebsockets
# for installing globally
pixi global install libuwebsockets
```
...
It is possible to list all of the versions of `libuwebsockets` available on your platform:
...
```
pixi search libuwebsockets --channel conda-forge
```
